...
class CropView: UIView {
  ...
  private func setupLayout() {
    NSLayoutConstraint.activate([
      ...
      checkboxImageView.topAnchor.constraint(equalTo: self.topAnchor, constant: 2.5),
      checkboxImageView.heightAnchor.constraint(equalToConstant: 25),
      checkboxImageView.leftAnchor.constraint(equalTo: self.leftAnchor, constant: 2.5),
