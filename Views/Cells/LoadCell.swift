...
class LoadCell: UITableViewCell, UITextFieldDelegate {
  ...
  private func setupLayout() {
    NSLayoutConstraint.activate([
      ...
      storageLabel.topAnchor.constraint(equalTo: quantityLabel.bottomAnchor, constant: 20),
      ...
      numberLabel.topAnchor.constraint(equalTo: storageLabel.bottomAnchor, constant: 20),
  ...
  @objc private func defineStorage() {
